                            ...
                            <div class="panel-body">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="searchItem" onkeyup="showBooks(this.value)" id="bookinput" class="form-control" placeholder="Search By CardId/ Book Name/ First Name here.."/>
                                ...
                                <script language="javascript" type="text/javascript">
                                    function showBooks(str) {
                                        ...
                                        var url = "ManageBooksCheckInServlet";
                                        url += "?BookName=" + str;
