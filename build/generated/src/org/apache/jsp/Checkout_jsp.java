...
public final class Checkout_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Checkout Books Page</title>\n");
      ...
      out.write("                                <h3 class=\"panel-title\">CheckOut Books</h3>\n");
      out.write("                            </div>\n");
      out.write("\n");
...
if(request.getAttribute("AvailableCheck")!=null){
      out.write("\n");
      out.write("                                                    ");
      out.print(request.getAttribute("AvailableCheck"));
}
                                            
      out.write("\n");
      out.write("                                            <tr>\n");
      out.write("                                                <td><img src=\"");
      out.print(request.getAttribute("Cover"));
      out.write("\" class=\"img-thumbnail\" alt=\"Cinque Terre\"></td>\n");
      out.write("                                                <td>Title : ");
      out.print(request.getAttribute("Title"));
      out.write("\n");
      out.write("                                                    <br> Isbn: ");
      out.print(request.getAttribute("Isbn10"));
      out.write("\n");
      out.write("                                                    <br>Authors:");
      out.print(request.getAttribute("Authors"));
      out.write("<br><hr>\n");
      out.write("                                                    <form action=\"CheckOutfromDbServlet\">\n");
      ...
      out.print(request.getAttribute("Isbn10"));
      out.write("\">\n");
      out.write("                                                        <input type=\"submit\" value=\"CheckOut\" class=\"btn btn-primary\">\n");
      out.write("                                                        \n");
      out.write("                                                    </form>\n");
      out.write("                                                    \n");
      out.write("                                                </td>\n");
      out.write("\n");
      out.write("                                                <!--<td><a href=\"CheckOutFromDb?Isbn10=\" class=\"btn btn-primary\">CheckOut</a></td>-->\n");
      out.write("                                                ");

//                                                        HttpSession hs = request.getSession();
//                                                        if (hs.getAttribute("AvailableCheck") != null) {
//                                                            out.println(hs.getAttribute("AvailableCheck"));
//                                                        }else{
//                                                            out.println("ELSE");
//                                                        }
                                                            if(request.getAttribute("AvailableCheck")!=null){
