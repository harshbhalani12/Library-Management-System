 ...
 * @author Admin
 */
public class CheckInBooksServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query = "select * from Book_Loans where Isbn10 = '"+Isbn10+"' AND DateIn is NULL";
            ResultSet rs = stmt.executeQuery(query);
            String CardId="";
            if(rs.next()){
               CardId = rs.getString(3);
               request.setAttribute("Isbn10", rs.getString(2));
            }else{
                msg = "Book is not there for check in...";
            }
